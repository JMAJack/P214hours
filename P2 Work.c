...
void mainmenu()
    ...
    {//registering patient
        ...
        {
            printf("---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
            printf("\nAssign the patient an ID Number:\t\t\t\t|\t");
...
patient *patients;//pointer
    ...
    else
    {
        ...
        printf("Enter the date of birth of the participant(dd mmm yyyy):\t\t\t\t|\t");
	    scanf("%d %s %d", &patients[i].Date.day, &patients[i].Date.month, &patients[i].Date.year);
        printf("--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
